...
export default [
  {
    ...
    children: [
      ...
      { path: '/at-a-glance/achievements', component: () => import('pages/at-a-glance/achievements'), name: 'at-a-glance-achievements', meta: { title: 'Achievements' } },
      ...
      { path: '/int-affiliation/achievements', component: () => import('pages/int-affiliation/achievements'), name: 'int-affiliation-achievements', meta: { title: 'achievements' } },
